        ...
        <Grid xs={12} md={3}>
          <Stack spacing={2}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'row', gap: { xs: 1, md: 2 } }}>
              ...
              {/* [mobile] call button */}
              <Button color='success' size='lg' disabled={!props.conversationId || !chatLLM} onClick={handleCallClicked} endDecorator={<CallIcon fontSize='large' />} sx={{ ...hideOnDesktop, boxShadow: 'sm' }}>
                Call
              </Button>
            ...
            {/* [desktop] */}
            <Button color='success' size='lg' disabled={!props.conversationId || !chatLLM} onClick={handleCallClicked} endDecorator={<CallIcon fontSize='large' />} sx={{ ...hideOnMobile, boxShadow: 'sm' }}>
              Call
            </Button>
